...
urlpatterns = patterns('',
                       url(r'^story/new', 'geonode.maps.views.new_map', {'template': 'maps/story.html'},
                           name='maploom-story-new'),
                       url(r'^story/(?P<storyid>[^/]+)/save$', 'maploom.geonode.views.save_story', name='save_story'),
